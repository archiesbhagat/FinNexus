...
export default function Trade() {
  ...
  const handleTradingViewSearch = () => {
    const query = symbol?.trim().toUpperCase();
    if (!query) return;
    window.open(`https://www.tradingview.com/chart/?symbol=${encodeURIComponent(query)}`, '_blank', 'noopener,noreferrer');
  };
          ...
          <div className="card">
            ...
            <div className="form-row">
              ...
              <div className="symbol-row">
                ...
                />
                <button className="btn outline tv-search" type="button" onClick={handleTradingViewSearch}>
                  Search TradingView
                </button>
              </div>
